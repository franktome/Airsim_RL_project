...
MODEL_FILENAME = '/data/PFEDRL/AutonomousDrivingCookbook/DistributedRL/Share/checkpoint_backup/local_run/10918.json'
...
def get_image(car_client):
    image_response = car_client.simGetImages([
    ...
    # crop and return as float array
    return image_rgba[76:135, 0:255, 0:3].astype(float)
...
while(True):
    ...
    print('State = {0}, steering = {1:.2f}, throttle = {2:.2f}, brake = {3:.2f}'.format(next_state, car_controls.steering, car_controls.throttle, car_controls.brake))
