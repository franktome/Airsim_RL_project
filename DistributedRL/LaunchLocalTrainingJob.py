...
airsim_path = '/data/PFEDRL/LinuxBlocks1.8.1/LinuxNoEditor'
...
train_script_path = os.path.join(os.getcwd(), 'Share/scripts_downpour/app/train_toy2.sh')
with open(train_script_path, 'w') as f:
    f.write(train_cmd)

# chmod +x Share/scripts_downpour/app/train.sh